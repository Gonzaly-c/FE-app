...
export function LoginPage() {
    ...
    try {
      ...
      switch (userToSet.role) {
        ...
        case "conductor":
          ...
          break;
        default:
          console.error("Rol no conocido"); // nunca debería llegar a pasar
      }
    } catch (error) {
  ...
  const buttonClass =
    "btn w-100 my-2 " + (isSubmitting ? "btn-info" : "btn-success");
        ...
        <div className="card-body mx-4">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {isLoginError && (
              <span className="text-danger mt-1">
                Los datos son erroneos o la cuenta no esta activa. Volver a
                intentar
              </span>
            )}
          </form>
          ...
          <div className="text-center mt-3">
            ...
            <a
              ...
              className="fw-bold link-underline text-info"
            >
              Registrate
            </a>
          </div>
