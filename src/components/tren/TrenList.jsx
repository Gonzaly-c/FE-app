              ...
              return (
                <tr key={tren.id}>
                  ...
                  <td className="text-center">
                    {tren.modelo ? tren.modelo : "Sin modelo"}
                  </td>
                  <td className="text-center">
                    {tren.color ? tren.color : "Sin color"}
                  </td>
                  <td className="text-center">
                    {tren.createdAt
                      ? new Date(
                          new Date(tren.createdAt).getTime() +
                            3 * 60 * 60 * 1000
                  ...
                  <td className="text-center">
                    <EstadoBadgeTren
                      estado={tren.estadoActual?.nombre ?? "Sin estado"}
                    />
                  </td>
                  ...
                  <td className="text-end">
                    ...
                    <button
                      ...
                      onClick={async () => deleteMutation(tren.id)}
                    >
                      Eliminar
                    </button>
                  </td>
