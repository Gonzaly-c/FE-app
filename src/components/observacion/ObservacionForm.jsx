    ...
    (
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="mb-3">
          ...
          {errors.idViaje && (
            <span className="text-danger">{errors.idViaje.message}</span>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.idCategoria && (
            <span className="text-danger">{errors.idCategoria.message}</span>
          )}
        </div>
        ...
        <div className="mb-3">
          ...
          {errors.observaciones && (
            <span className="text-danger">{errors.observaciones.message}</span>
          )}
        </div>
        ...
        {isErrorPost && (
          <span className="text-danger">Error al crear la observacion</span>
        )}
        {isErrorPut && (
