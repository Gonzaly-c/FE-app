                ...
                return (
                  <tr key={carga.id}>
                    ...
                    <td className="text-center">
                      {carga.name ? carga.name : "Sin nombre"}
                    </td>
                    <td className="text-center">
                      {carga.precio ? carga.precio : "Sin precio"}
                    </td>
                    <td className="text-center">
                      {carga.tipoCarga && carga.tipoCarga.estado === "Activo"
                        ? carga.tipoCarga.name
                        : "Sin tipo de carga"}
                    </td>
                    <td className="text-center">
                      {carga.createdAt
                        ? new Date(
                            new Date(carga.createdAt).getTime() +
                              3 * 60 * 60 * 1000
                    ...
                    <td className="text-end">
                      ...
                      <button
                        ...
                        onClick={async () => deleteMutation(carga.id)}
                      >
                        Eliminar
                      </button>
                    </td>
