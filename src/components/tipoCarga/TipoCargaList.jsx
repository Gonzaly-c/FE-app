              ...
              return (
                <tr key={tipoCarga.id}>
                  ...
                  <td className="text-center">
                    {tipoCarga.name ? tipoCarga.name : "Sin nombre"}
                  </td>
                  <td className="text-center">
                    {tipoCarga.desc ? tipoCarga.desc : "Sin descripcion"}
                  </td>
                  <td className="text-center">
                    {tipoCarga.createdAt
                      ? new Date(
                          new Date(tipoCarga.createdAt).getTime() +
                            3 * 60 * 60 * 1000
                  ...
                  <td className="text-end">
                    ...
                    <button
                      ...
                      onClick={async () => deleteMutation(tipoCarga.id)}
                    >
                      Eliminar
                    </button>
                  </td>
