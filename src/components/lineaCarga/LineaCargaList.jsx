                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="text-center">
                        {lineaCarga.viaje.id ? lineaCarga.viaje.id : "Sin id"}-
                        {lineaCarga.viaje.recorrido.ciudadSalida
                          ? lineaCarga.viaje.recorrido.ciudadSalida
                          : "Sin ciudad de salida"}
                        /
                        {lineaCarga.viaje.recorrido.ciudadLlegada
                          ? lineaCarga.viaje.recorrido.ciudadLlegada
                          : "Sin ciudad de llegada"}{" "}
                        (
                        {lineaCarga.viaje.fechaIni
                          ? new Date(
                              new Date(lineaCarga.viaje.fechaIni).getTime() +
                                3 * 60 * 60 * 1000
                      ...
                      <td className="text-center">
                        {lineaCarga.carga.name &&
                        lineaCarga.carga.estado == "Activo"
                          ? lineaCarga.carga.name
                          : "Sin carga"}
                      </td>
                      <td className="text-center">
                        {lineaCarga.cantidadVagon
                          ? lineaCarga.cantidadVagon
                          : "Sin cantidad de vagones"}
                      </td>
                      <td className="text-center">
                      ...
                      <td className="text-end">
                        ...
                        <button
                          ...
                          onClick={async () => deleteMutation(lineaCarga.id)}
                        >
                          Eliminar
                        </button>
                      </td>
